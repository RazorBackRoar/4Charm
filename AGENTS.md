...
3. **Build System**: ALWAYS use `razorbuild 4Charm`. NEVER use `py2app`, `briefcase`, or manual `pyinstaller` commands.
...
3. **Build**: `razorbuild 4Charm` (Builds .app + DMG using universal system)
