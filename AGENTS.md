...
- Jules runs tasks in an Ubuntu VM; macOS runtime behavior, GUI behavior, PySide6 interaction, network behavior, and packaged-app behavior are not proven there.
